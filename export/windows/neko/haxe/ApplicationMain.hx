...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "PI-Xel", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "PI-Xel";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "PI-Xel", null, { width: 700, height: 525 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 700, height: 525 });
			#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 700, 525, "null");
		#end
		#else
		create ();
		#end
