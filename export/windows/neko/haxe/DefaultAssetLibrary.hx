...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/images/cube_anim.png", AssetType.IMAGE);
		...
		type.set ("assets/music/rayman_1.ogg", AssetType.MUSIC);
		className.set ("flixel/sounds/beep.ogg", __ASSET__flixel_sounds_beep_ogg);
		type.set ("flixel/sounds/beep.ogg", AssetType.SOUND);
		className.set ("flixel/sounds/flixel.ogg", __ASSET__flixel_sounds_flixel_ogg);
		type.set ("flixel/sounds/flixel.ogg", AssetType.SOUND);
		...
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/cube_anim.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		...
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/tmp/add_star.rb";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/images/tmp/background_old.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/tmp/cube.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/tmp/cube_destroyed.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/tmp/cube_eat.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/tmp/star.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/tree.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/music/rayman_1.ogg";
		path.set (id, id);
